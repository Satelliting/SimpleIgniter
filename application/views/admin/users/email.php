				...
				<div class="card-body">
					<?=form_open(current_url());?>
						<fieldset>
							...
							<div class="form-group">
								<input class="form-control" name="emailSubject" type="text" placeholder="Email Subject" required autofocus data-toggle="tooltip" data-placement="left" title="Email Subject" />
							</div>
							<div class="form-group">
