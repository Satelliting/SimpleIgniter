					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav mr-auto">
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="#" id="auctionDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										Users
									</a>
									<div class="dropdown-menu" aria-labelledby="auctionDropdown">
										<a class="dropdown-item" href="<?= site_url('admin/users'); ?>">Home</a>
										<a class="dropdown-item" href="<?= site_url('admin/users/list'); ?>">List of Users</a>
									</div>
								</li>
							</ul>
						</div>
